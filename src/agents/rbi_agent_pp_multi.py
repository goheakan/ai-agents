...
STRATEGIES_FOLDER = "src/data/rbi_pp_multi/web_search_research/final_strategies"
...
# 🌙 Moon Dev: Use Ollama (local, free) instead of xai
RESEARCH_CONFIG = {
    "type": "ollama",
    "name": "0xroyce/plutus"  # One of your available models
}
